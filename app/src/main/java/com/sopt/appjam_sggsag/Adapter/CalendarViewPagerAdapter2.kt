...
class CalendarViewPagerAdapter2(fm: FragmentManager?, val fCount: Int, val listener:GetYearMonthTab) : FragmentStatePagerAdapter(fm) {
    ...
    override fun getItem(position: Int): Fragment? {
        ...
        val fragment = CalendarDetailFragment2() // Fragment 생성
